...
export default function Home() {
  return (
    <div className="container">
      <h1 className={styles.title}>Joan Twinomugyisha</h1>
      <p>+256 784 716 797 / +256 705 959 119 | twinomugyishajoan@gmail.com</p>
      <p>Namanve, Kampala - Uganda</p>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>Organize employer visits, recruitment drives, and networking events.</li>
          <li>Develop mentorship framework, manage mentors, track outcomes.</li>
          <li>Maintain accurate records using data management systems.</li>
          <li>Prepare regular reports for review by leadership and stakeholders.</li>
          <li>Collaborate with training team to align curriculum with industry needs.</li>
          <li>Represent Refactory at industry events and forums.</li>
        </ul>
        ...
        <ul className={styles.list}>
          ...
          <li>Provide basic user support for platforms like SOMA.</li>
          <li>Proofread all communications for professionalism.</li>
          <li>Pursue personal growth to enhance skills.</li>
        </ul>
        ...
        <ul className={styles.list}>
          ...
          <li>Generated reports on call center activities.</li>
          <li>Monitored agent performance and provided coaching.</li>
          <li>Enforced quality standards and schedule adherence.</li>
        </ul>
        ...
        <ul className={styles.list}>
          ...
          <li>Collaborated with teams to resolve complex issues.</li>
          <li>Used empathy and active listening for tailored solutions.</li>
          <li>Met or exceeded performance targets.</li>
          <li>Trained new customer service representatives.</li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>Proficient in data management and reporting tools (Microsoft Excel, Google Sheets)</li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>Windows Operating System – Cyber Girls Fellowship</li>
          <li>CompTIA Linux+ – InfoSec</li>
          <li>ITIL 4 – Cyber Girls Fellowship</li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>Currently pursuing postgraduate studies alongside professional responsibilities.</li>
        </ul>
      </section>
